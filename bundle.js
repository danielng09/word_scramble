...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = __webpack_require__(160);
	var Footer = __webpack_require__(161);
	var ScoreModal = __webpack_require__(162);
	...
	module.exports = React.createClass({
	  ...
	  componentDidUpdate: function componentDidUpdate() {
	    if (this.state.word && this.state.guessedLetters.length === this.state.word.length && this.state.isCheckingGuess === false) {
	      this.checkGuess();
	    }
	  },
	  ...
	  removeGuessedLetter: function removeGuessedLetter() {
	  ...
	  checkWordInDictionary: function checkWordInDictionary(word) {
	    if (Utils.dictionary[word] && !this.state.validWords[word]) {
	      var addPoints = Utils.calculateValue(word);
	  ...
	  scrambleWordtoLetters: function scrambleWordtoLetters(word) {
...
/***/ function(module, exports) {
	...
	$l.isEmptyObject = function (obj) {
	  function hasKeys(o) {
	    for (var name in o) {
	      if (o.hasOwnProperty(name)) return true;
	    }
	    return false;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeaderboardEntry = __webpack_require__(164);
	...
	module.exports = React.createClass({
	  ...
	  shiftScoresDown: function shiftScoresDown(index) {
	  ...
	  handleSubmitHighScore: function handleSubmitHighScore(name, index) {
	    var leaderboard = this.state.leaderboard;
	  ...
	  displayLeaderboard: function displayLeaderboard(entry, idx) {
	    ...
	    return React.createElement(LeaderboardEntry, {
	      key: idx,
	      index: idx,
	      name: entry.name,
	      score: entry.score,
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('hr', { id: 'modal-line-break' }),
	        React.createElement(
	          'table',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = {
	  ...
	  hasElementInArray: function hasElementInArray(array, ele) {
	  ...
	  calculateValue: function calculateValue(word) {
	    var total = 0;
